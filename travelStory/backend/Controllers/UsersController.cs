...
namespace backend.Controllers
{
    ...
    [ApiController]
    public class UsersController(TravelDbContext db, IConfiguration config) : ControllerBase
    {
        private readonly TravelDbContext _db = db;
        ...
        public async Task<ActionResult<string>> Register([FromForm] UserCreateDto userDto,IFormFile? profilePicture)
        {
            ...
            var user = new User
            {
                ...
                Email = userDto.Email,                PasswordHash = hmac.ComputeHash(Encoding.UTF8.GetBytes(userDto.Password)),
