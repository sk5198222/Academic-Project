...
export default function AddPetPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post("https://localhost:7206/api/pets", formDataToSend, {
        headers: {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-900 p-6 py-10">
      ...
      >
        <h2 className="text-3xl font-bold text-center text-slate-800 mb-8">Add a New Pet</h2>
